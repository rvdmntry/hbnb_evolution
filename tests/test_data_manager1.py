...
class TestDataManager(unittest.TestCase):
    ...
    def test_save_and_get_place(self):
        place = Place(host_id=uuid.uuid4(), name="Lovely Apartment", description="A beautiful place", address="123 house", number_of_rooms=2, number_of_bathrooms=1, max_guests=4, price_per_night=150.0, latitude=40.7128, longitude=-74.0060, city_id=uuid.uuid4(), amenity_ids=[])
